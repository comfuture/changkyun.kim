...
description: 오래된 MUD 레거시 코드를 복구하며 파일명 인코딩, 리소스 재구성, C 컴파일 문제를 해결한 기록입니다.
...
복구된 서버에서 실제로 캐릭터 생성 입력이 진행되는 장면이다.

![무한대전 복구 실행 화면](/blog/2026-02/revive-muhan-legacy-mud/recovery-terminal.png)
